...
int compare(struct TextPosition o1, struct TextPosition o2){
  ...
  int x1 = o1.getXDirAdj;
  int x2 = o2.getXDirAdj;

  int pos1YBottom = o1.getYDirAdj;
  int pos2YBottom = o2.getYDirAdj;
  // note that the coordinates have been adjusted so 0,0 is in upper left
  int pos1YTop = pos1YBottom - o1.getHeightDir;
  int pos2YTop = pos2YBottom - o2.getHeightDir;
