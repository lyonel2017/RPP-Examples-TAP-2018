...
int indexOf(struct PokerHand o1, int val){
  ...
  /*@ loop invariant 0 <= i <= 13;
    @ loop invariant \forall integer k; 0 <= k < i ==> o1.hand[k] != val;
    @ loop assigns i;
    @ loop variant 13-i;*/
  for(i = 0; i < 13; i++){
    if(o1.hand[i] == val){
...
int lastIndexOf(struct PokerHand o1, int val){
  ...
  /*@ loop invariant 0 <= i <= 13;
    ...
    @ loop invariant \forall integer k; j < k < i ==> o1.hand[k] != val;
    @ loop invariant j != -1 ==> o1.hand[j] == val;
    @ loop assigns i,j;
    @ loop variant 13-i;*/  
  for(i = 0; i < 13; i++){
    if(o1.hand[i] == val){
...
int countOccurrencesOf(struct PokerHand o1, int val){
  ...
  /*@ loop invariant 0 <= i <= 13;
    ...
    @ loop invariant j == Count(o1,i,val);
    @ loop assigns i,j;
    @ loop variant 13-i;*/
  for(i = 0; i < 13; i++){
    if(o1.hand[i] == val){
